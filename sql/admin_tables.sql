...
-- Run this on your existing proteq_db database
...
-- Safety protocols table (enhanced)
...
-- Add some sample evacuation routes
...
-- Add some sample enhanced safety protocols
...
-- Update users table to add more fields if they don't exist
ALTER TABLE `users` 
...
-- Update staff table to add more fields if they don't exist
ALTER TABLE `staff` 
